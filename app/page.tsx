...
const useCases = [
  {
    ...
    description: 'Streamline new client intake processes with intelligent document processing and automated compliance checks.',
    icon: Users,
  },
  {
    name: 'Portfolio Rebalancing',
    description: 'Automate portfolio analysis and rebalancing workflows to maintain optimal asset allocation.',
    icon: TrendingUp,
  },
  {
    name: 'Compliance Reporting',
    description: 'Generate regulatory reports automatically with real-time data integration and audit trails.',
    icon: Shield,
  },
  {
    name: 'Client Communication',
    description: 'Automate personalized client communications, updates, and follow-up scheduling.',
    icon: CheckCircle,
  },
  {
    name: 'Data Processing',
    description: 'Process financial data from multiple sources with AI-powered validation and analysis.',
    icon: BarChart3,
  },
  {
    name: 'Workflow Management',
    description: 'Coordinate complex multi-step processes across your team with intelligent task routing.',
    icon: Workflow,
  },
]
          ...
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-8 flex justify-center">
              <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 dark:text-gray-300 ring-1 ring-gray-900/10 dark:ring-gray-100/10 hover:ring-gray-900/20 dark:hover:ring-gray-100/20 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm">
                Specialized automation solutions for financial advisors.{' '}
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Automate your business workflows with intelligent AI systems built for scale. 
              Specialized in automations for financial advisors and professionals.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
              Specialized automations for financial advisors
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
              Streamline your practice with intelligent automation solutions designed specifically for financial professionals.
            </p>
          </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-primary-100">
              Get started with AI-powered automation solutions designed specifically for financial advisors.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="mailto:pawan@bravosautomations.io"
